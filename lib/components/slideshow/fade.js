  ...
  _createClass(Fade, [{
    ...
    value: function render() {
      ...
      return React.createElement(
        'div',
        { className: 'container' },
        this.props.showArrows && React.createElement(
          'div',
        ...
        this.props.showIndicator && React.createElement('div', { className: 'indicator', style: {
          ...
          React.createElement(
            ...
            images.map(function (each, key) {
              return React.createElement(
                ...
                React.createElement('img', { alt: each.alt, src: each.src })
              );
            })
          )
        ),
